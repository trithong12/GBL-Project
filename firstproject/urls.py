...
urlpatterns = [
    ...
    url(r'retrieve_post/(?P<post_id>\d+)/$', views.PostDetailView.as_view(), name = 'post_detail'),
    url(r'retrieve_post/(?P<slug>[-\w]+)/$', views.PostDetailView.as_view(), name = 'post_detail_slug'),
